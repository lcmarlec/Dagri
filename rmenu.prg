...
IF FILE("CPYMDL.DAT")
   #IF "VISUAL FOXPRO" $ UPPER(version(1))
      EXTERNAL LIBRARY GxVfUt5.DLL
      SET LIBRARY TO GxVfUt5.DLL ADDITIVE
   #ELSE
      EXTERNAL LIBRARY GxWUtil
      SET LIBRARY TO GxWUtil ADDITIVE
   #ENDIF
    = GXSNDWM( "GXReorgOk")
   #IF "VISUAL FOXPRO" $ UPPER(version(1))
      EXTERNAL LIBRARY GxVfUt5.DLL
